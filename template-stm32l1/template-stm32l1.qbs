...
import qbs
import "qbs/stm32l1.qbs" as stm32l1
...
Project {
     ...
     * - STM32L162xE
     */
    readonly property string microcontroller_series: "STM32L100xB"
    ...
    stm32l1 {
        ...
        property string halPath       : basePath + "/Drivers/STM32L1xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32L1xx/Include")
            }
