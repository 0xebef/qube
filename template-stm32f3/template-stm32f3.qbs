...
import qbs
import "qbs/stm32f3.qbs" as stm32f3
...
Project {
     ...
     * - STM32F398xx
     */
    readonly property string microcontroller_series: "STM32F301x8"
    ...
    stm32f3 {
        ...
        property string halPath       : basePath + "/Drivers/STM32F3xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32F3xx/Include")
            }
