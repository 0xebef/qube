...
import qbs
import "qbs/stm32h7.qbs" as stm32h7
...
Project {
     ...
     * - STM32H753xx
     */
    readonly property string microcontroller_series: "STM32H743xx"
    ...
    stm32h7 {
        ...
        property string halPath       : basePath + "/Drivers/STM32H7xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32H7xx/Include")
            }
