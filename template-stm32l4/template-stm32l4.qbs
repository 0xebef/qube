...
import qbs
import "qbs/stm32l4.qbs" as stm32l4
...
Project {
     ...
     * - STM32L4A6xx
     */
    readonly property string microcontroller_series: "STM32L431xx"
    ...
    readonly property string stemwin_wc : "wc16"// ST's STemWin wchar type (wc16 or wc32)
    ...
    stm32l4 {
        ...
        property string halPath       : basePath + "/Drivers/STM32L4xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32L4xx/Include")
            }
            ...
            if (project.stemwin) {
                if (project.freertos) {
                    if (qbs.buildVariant === "release") {
                        staticLibraries.push("STemWin_CM4_OS_" + project.stemwin_wc + "_ot")
                    } else {
                        staticLibraries.push("STemWin_CM4_OS_" + project.stemwin_wc)
                    }
                } else {
                    if (qbs.buildVariant === "release") {
                        staticLibraries.push("STemWin_CM4" + project.stemwin_wc + "_ot")
                    } else {
                        staticLibraries.push("STemWin_CM4" + project.stemwin_wc)
                    }
                }
            }
