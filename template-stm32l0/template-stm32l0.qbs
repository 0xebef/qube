...
import qbs
import "qbs/stm32l0.qbs" as stm32l0
...
Project {
     ...
     * - STM32L083xx
     */
    readonly property string microcontroller_series: "STM32L011xx"
    ...
    stm32l0 {
        ...
        property string halPath       : basePath + "/Drivers/STM32L0xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32L0xx/Include")
            }
