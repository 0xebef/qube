...
import qbs
import "qbs/stm32f2.qbs" as stm32f2
...
Project {
     ...
     * - STM32F217xx
     */
    readonly property string microcontroller_series: "STM32F205xx"
    ...
    stm32f2 {
        ...
        property string halPath       : basePath + "/Drivers/STM32F2xx_HAL_Driver"
        ...
        cpp.includePaths: {
            ...
            if (project.cmsis) {
                ...
                includePaths.push(cmsisPath + "/Device/ST/STM32F2xx/Include")
            }
